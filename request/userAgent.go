...
func init() {
	...
	uaMap["Internet Explorer"] = []string{"Mozilla/5.0 (compatible; MSIE 10.6; Windows NT 6.1; Trident/5.0; InfoPath.2; SLCC1; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; .NET CLR 2.0.50727) 3gpp-gba UNTRUSTED/1.0",
	...
	uaMap["Firefox"] = []string{"Mozilla/5.0 (Windows NT 5.1; rv:31.0) Gecko/20100101 Firefox/31.0",
	...
	uaMap["Chrome"] = []string{"Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36",
	...
	uaMap["Opera"] = []string{"Opera/9.80 (Windows NT 6.0) Presto/2.12.388 Version/12.14",
